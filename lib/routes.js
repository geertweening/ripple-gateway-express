...
module.exports = (function(){
  function configure(app, passport, adapter) {
    var ctrls = require('./controllers/index.js')(adapter);
    ...
    app.get('/api/v1/user', auth(), ctrls['users'].read);
    app.get('/api/v1/users/:id', auth(), ctrls['users'].read);
